...
namespace SkiaSharpDraw
{
    ...
    {
        public static EGLDisplay eglDisplay = Egl.EGL_NO_DISPLAY;
        ...
        public void CreateSurface(SwapChainPanel panel, Size? renderSurfaceSize, float? resolutionScale)
        {
            ...
            // If a render surface size is specified, add it to the surface creation properties
               ...
               // PropertySetExtensions.AddSize(surfaceCreationProperties, Egl.EGLRenderSurfaceSizeProperty, new Size(2000,2000));
            ...
            var isB = Marshal.IsComObject(surfaceCreationProperties);
            EGLDisplay display = Marshal.GetIUnknownForObject(surfaceCreationProperties);
            surface = Egl.eglCreateWindowSurface(eglDisplay, eglConfig, display, surfaceAttributes);
