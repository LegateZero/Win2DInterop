...
namespace SkiaSharp.Views.GlesInterop
{
    internal static class Egl
    {
        ...
        [DllImport(libEGL)]
        public static extern EGLSurface eglCreatePbufferFromClientBuffer(EGLDisplay dpy, EGLenum buffType, EGLClientBuffer buffer, EGLConfig config, int[] attrib_list);
    }
